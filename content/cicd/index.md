...
- [ ] [Drone CI, Woodpecker CI](drone-woodpecker.md)

### Kubernetes-native CI/CD

- [ ] [Tekton (CNCF Incubating)](tekton.md)
...
- [ ] [Testcontainers (통합 테스트 표준)](testcontainers.md)
...
- [ ] [SLSA Provenance를 CI에서 생성 (GHA Attestation, Tekton Chains)](slsa-in-ci.md)
- [ ] [빌드 아티팩트 서명 (cosign, Sigstore)](build-signing.md)
