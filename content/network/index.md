...
- [ ] [External DNS (K8s 리소스 기반 DNS 자동화)](external-dns.md)
...
- [ ] [GAMMA: Gateway API for Service Mesh](gamma.md)
...
- [ ] [VPC Flow Logs와 대규모 네트워크 관측](vpc-flow-logs.md)
- [ ] [sFlow, NetFlow, IPFIX](flow-protocols.md)
- [ ] [Hubble과 L3-L7 플로우 관측](hubble-network.md)
