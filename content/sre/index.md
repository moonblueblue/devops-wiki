...
- [ ] [SRE 원칙](principles/sre-principles.md) — Google SRE 원칙, Dickerson Pyramid
- [ ] [SLI·SLO·SLA](principles/sli-slo-sla.md) — 정의와 관계, 현실 함정

### SLI·SLO·에러 버짓

- [ ] [SLI 선정](slo/sli-selection.md) — CUJ (Critical User Journey), 4 Golden Signals
- [ ] [SLO Burn Rate](slo/slo-burn-rate.md) — Burn Rate 수학, 다중 창 판단
- [ ] [Error Budget 정책](slo/error-budget-policy.md) — 소진 시 조치 (배포 동결, 롤백 강제)

### 장애 대응

- [ ] [Incident Response](incident/incident-response.md) — IRT, Commander, War Room 운영, 커뮤니케이션
- [ ] [On-call 로테이션](incident/on-call-rotation.md) — 로테이션, 휴식, 핸드오프

### 포스트모템·RCA

- [ ] [포스트모템](postmortem/postmortem.md) — Blameless 원칙, Google 템플릿, 실무 포맷 통합
