...
- [x] [Terraform Providers](terraform/terraform-providers.md) — vSphere·OpenStack·Kubernetes·Helm 등 온프레미스 provider 중심
- [x] [OpenTofu vs Terraform](terraform/opentofu-vs-terraform.md) — 분기 이후 차이, 마이그레이션
